...
/// <summary>
/// Represents a fixed-size string of up to 63 bytes (e.g., Disk Copy image names).
/// </summary>
[InlineArray(Size)]
public struct String63 : ISpanFormattable, IEquatable<String63>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="String63"/> struct.
    /// </summary>
    ...
    public String63(ReadOnlySpan<byte> data)
    {
        if (data.Length > Size)
        {
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(String63 other) =>
        AsReadOnlySpan().SequenceEqual(other.AsReadOnlySpan());

    /// <inheritdoc/>
    public override readonly bool Equals(object? obj) =>
        obj is String63 other && Equals(other);
    ...
    /// <summary>
    /// Determines whether two <see cref="String63"/> instances are equal.
    /// </summary>
    public static bool operator ==(String63 left, String63 right) => left.Equals(right);

    /// <summary>
    /// Determines whether two <see cref="String63"/> instances are not equal.
    /// </summary>
    public static bool operator !=(String63 left, String63 right) => !left.Equals(right);

    /// <summary>
    /// Creates a <see cref="String63"/> from the specified character span.
    /// </summary>
    /// <param name="value">The character span to create from. Must be at most <see cref="Size"/> characters.</param>
    /// <returns>The new <see cref="String63"/> instance.</returns>
    /// <exception cref="ArgumentException">Thrown when the value is longer than <see cref="Size"/> characters.</exception>
    public static String63 FromString(ReadOnlySpan<char> value)
    {
    ...
    /// <summary>
    /// Implicitly converts the <see cref="String63"/> to a <see cref="string"/>.
    /// </summary>
    /// <param name="str">The <see cref="String63"/> instance.</param>
    /// <returns>The converted string.</returns>
    public static implicit operator string(String63 str) => str.ToString();
}
